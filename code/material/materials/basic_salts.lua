...
M.fe2o3 = materials.new_material("iron_trioxide", {
...
M.cr2o3 = materials.new_material("chromium_trioxide", {
...
M.al2o3 = materials.new_material("aluminium_trioxide", {
...
M.k2o = materials.new_material("potassium_oxide", {
...
M.alcl3 = materials.new_material("aluminium_chloride", {
...
M.cr2o3al2o3 = materials.new_material("chromium_aluminium_oxide", {
...
M.cr2o3fe2o3 = materials.new_material("chromium_iron_oxide", {
	formula = {{"chromium_trioxide", 1}, {"iron_trioxide", 1}},
	types = {"ingot", "catalyst"},
	description = S"material.cr2o3fe2o3",
}):generate_data("melting_point"):generate_interactions():generate_recipe("trinium:alloysmelting_tower")

M.fe7k2oal2o3 = materials.new_material("ipa_compound", {
