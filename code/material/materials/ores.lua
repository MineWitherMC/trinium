...
M.antracite = materials.new_material("antracite", {
	formula = {{"carbon", 4}},
...
M.graphite = materials.new_material("graphite", {
	formula = {{"carbon", 6}},
	types = {"dust", "ore"},
	color = {50, 50, 50},
...
M.tennantite = materials.new_material("tennantite", {
...
M.diamond = materials.new_material("diamond", {
	formula = {{"graphite", 8}},
	types = {"dust", "gem", "ore"},
	color = {200, 255, 255},
...
M.coal = materials.new_material("coal", {
	formula = {{"carbon", 2}},
	types = {"dust", "gem", "ore"},
	color = {21, 21, 21},
