...
do
	M.water = materials.new_material("water", {
	...
	M.hydrogen = materials.new_material("m_hydrogen", {
		formula = {{"hydrogen", 2}},
		types = {"cell"},
		description = S"material.hydrogen", 
	})

	M.nitrogen = materials.new_material("m_nitrogen", {
		formula = {{"nitrogen", 2}},
		types = {"cell"},
		description = S"material.nitrogen", 
	})

	M.oxygen = materials.new_material("m_oxygen", {
		formula = {{"oxygen", 2}},
		types = {"cell"},
		description = S"material.oxygen", 
	})

	M.chlorine = materials.new_material("m_chlorine", {
		formula = {{"chlorine", 2}},
		types = {"cell"},
		description = S"material.chlorine", 
	})

	M.hcl = materials.new_material("hydrogen_chloride", {
	...
	M.ammonia = materials.new_material("ammonia", {
	...
	M.hcn = materials.new_material("hydrogen_cyanide", {
	...
	M.h2s = materials.new_material("hydrogen_sulfide", {
...
-- Organics
do
	M.methane = materials.new_material("methane", {
	...
	M.ethene = materials.new_material("ethylene", {
	...
	M.propene = materials.new_material("propene", {
	...
	M.butene = materials.new_material("butane", {
	...
	M.benzene = materials.new_material("benzene", {
	...
	M.toluene = materials.new_material("toluene", {
	...
	M.isooctane = materials.new_material("isooctane", {
	...
	M.chloroethane = materials.new_material("chloroethane", {
	...
	M.ethylbenzene = materials.new_material("ethylbenzene", {
	...
	M.acetylene = materials.new_material("acetylene", {
	...
	M.styrene = materials.new_material("styrene", {
	...
	M.butadiene = materials.new_material("butadiene", {
	...
	M.acrylonitrile = materials.new_material("acrylonitrile", {
	...
	M.abspc = materials.new_material("abs_plastic_compound", {
	...
	M.abs = materials.new_material("abs_plastic", {
	...
	M.fluixine = materials.new_material("fluixine_silicide", {
		formula = {{"fluixine_ring", 1}, {"silicon", 2}},
		types = {"cell", "gem", "pulp"},
		color = {135, 55, 200},
		description = S"material.fluixine_silicide",
	}):generate_interactions()
	
	M.sodiumfluix = materials.new_material("sodium_fluix_silicide", {
		formula = {{"sodium", 1}, {"fluixine_ion", 1}, {"silicon", 2}},
		types = {"cell", "gem", "pulp"},
		color = {55, 55, 200},
		description = S"material.sodium_fluix_silicide",
	}):generate_interactions()
	
	M.glass = materials.new_material("glass", {
		formula = {{"silicon", 1}, {"oxygen", 2}},
		types = {"plate", "dust"},
		color = {250, 250, 250},
		description = S"material.glass",
	})
	trinium.register_recipe("trinium:blast_furnace",
		{"trinium:block_sand"}, {M.glass:get("dust")}, {melting_point = 1400})
	trinium.register_recipe("trinium:crude_compressor",
		{M.glass:get("dust")}, {M.glass:get("plate")})
end