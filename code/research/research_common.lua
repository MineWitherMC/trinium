...
trinium.register_recipe("trinium:crafting", {[2] = "trinium:block_stone", [4] = "trinium:block_stone", [5] = "trinium:material_brick_antracite", [6] = "trinium:block_stone", [8] = "trinium:block_stone"}, {"trinium:research_chassis 4"}, {})
...
trinium.register_recipe("trinium:crafting", {"trinium:material_ingot_iron", "trinium:material_brick_antracite", "trinium:material_ingot_iron", "trinium:material_brick_antracite", "trinium:research_chassis", "trinium:material_brick_antracite", "trinium:material_ingot_iron", "trinium:material_brick_antracite", "trinium:material_ingot_iron"}, {"trinium:research_casing"}, {})
